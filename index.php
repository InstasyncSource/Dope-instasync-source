<?php
    if(strpos($_SERVER['HTTP_HOST'], "anti-graal.com") === false)
    {
    ...
    mysql_select_db("graalxrl_sync", $connection);
        ...
        <div class="container"> 
            ...
            <div class="index-content">
                <div class="content-header">
                    ...
                    <div class="right">
                        <div>
                            <a class="twitter-timeline"  href="https://twitter.com/TerrorSquad0x0"  data-widget-id="364186530270543872" height="200" width="250">Tweets by @InstaSynch</a>
